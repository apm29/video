...
import com.apm29.puppeyvideo.utils.BitmapUtil;
import com.apm29.puppeyvideo.utils.RandomUtil;
...
public class CustomMediaController extends MediaController {
    ...
    VideoFullScreenActivity activity;
    ...
    public CustomMediaController(Context context) {
        ...
        activity=(VideoFullScreenActivity) context;
    ...
    protected void initOtherView() {
        ...
        mtanMuSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked){
                    mtanMuSwitch.setBackgroundColor(getResources().getColor(R.color.zhaosha_bright_orange));
                    //开启弹幕
                    mDanmakuView.prepare(mParser, mDanmakuContext);
                    mDanmakuView.show();
                }else{
                    mtanMuSwitch.setBackgroundColor(getResources().getColor(R.color.zhaosha_default_gray_bg));
                    //关闭弹幕
                    mDanmakuView.hide();
                }
            }
